package com.potatomato.walkietalkie.network;

import com.potatomato.walkietalkie.WalkieTalkie;
import com.potatomato.walkietalkie.network.packet.c2s.ActivateButtonC2SPacket;
import com.potatomato.walkietalkie.network.packet.c2s.CanalButtonC2SPacket;
import com.potatomato.walkietalkie.network.packet.c2s.MuteButtonC2SPacket;
import com.potatomato.walkietalkie.network.packet.c2s.UpdateSpeakerC2SPacket;
import com.potatomato.walkietalkie.network.packet.s2c.ButtonS2CPacket;
